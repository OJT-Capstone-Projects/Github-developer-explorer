...
/* ================================================
   ...
   (Demo wiring – Member 2 can replace this block
    with real GitHub API integration)
   ================================================ */
searchBtn.addEventListener("click", function () {
  ...
  // Replace everything below this comment with your
  // real API fetch logic.  Call the functions like:
  //
  //   showLoader();
  ...
  //         displayLanguages(langData);
  //     })
  //     .catch(function(err) {
  //         showError(err.message);
  //     });
  //
  // ── Demo mode (remove when integrating API) ─────
  showLoader();
  ...
  setTimeout(function () {
    ...
    var demoProfile = {
      ...
      name:        "Dan Abramov",
      username:    "gaearon",
      bio:         "Working on @facebook. Lately been thinking a lot about whiteboards.",
      followers:   74200,
      following:   171,
      publicRepos: 263
    };
    ...
    var demoRepos = [
      ...
      },
      {
        ...
        description: "Tweak React components in real time without unmounting.",
        stars:       12000,
        forks:       780,
        language:    "JavaScript"
      },
      {
        name:        "overreacted.io",
        description: "Personal blog source code by Dan Abramov.",
        stars:       7100,
        forks:       1900,
        language:    "JavaScript"
      },
      ...
      {
        name:        "react-devtools",
        description: "An extension that allows inspection of React component hierarchy.",
        stars:       14200,
        forks:       1600,
        language:    "JavaScript"
      },
      {
        name:        "just-a-test",
        description: "Testing something experimental.",
        stars:       12,
        forks:       3,
        language:    "TypeScript"
      }
    ...
    displayRepositories(demoRepos);
    displayLanguages(demoLanguages);
